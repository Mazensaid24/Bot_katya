...
def start(message):
    ...
    butteon = types.InlineKeyboardButton("مطور البوت", url="https://t.me/Ve_G4")
    buttoon = types.InlineKeyboardButton("قناة البوت", url="https://t.me/Source_Katya")
    private.add(button)
...
print("تم تشغيل البوت اذا وقف معك شي تواصل معي @Ve_G4")
